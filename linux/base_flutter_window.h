...
#ifndef WAYLAND_MULTI_WINDOW_LINUX_BASE_FLUTTER_WINDOW_H_
#define WAYLAND_MULTI_WINDOW_LINUX_BASE_FLUTTER_WINDOW_H_
...
#endif //WAYLAND_MULTI_WINDOW_LINUX_BASE_FLUTTER_WINDOW_H_
