...
#ifndef WAYLAND_MULTI_WINDOW_LINUX_WINDOW_CHANNEL_H_
#define WAYLAND_MULTI_WINDOW_LINUX_WINDOW_CHANNEL_H_
...
#endif //WAYLAND_MULTI_WINDOW_LINUX_WINDOW_CHANNEL_H_
